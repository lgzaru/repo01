    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                          <h5 class="modal-title" id="exampleModalLabel-2">Edit Users</h5>
        				...
        				<form name="form1" id="form1" action="/ContitouchH/UserAccountsActions"  method="post">
                      ...
                      <%Connection mysqlConn1 = null;
                        ...
                        <tr>
                        	...
                        	<td><input class=" form-control type="text" name="id"  value="<%=rs.getString("id") %>" disabled></td>
        		  			<td><input class=" form-control type="text" name="name" value="<%=rs.getString("name") %>" disabled  ></td>
        		  			
            	  			<td>
            	  			<select name="userroles" id="userroles" class="form-control" >
                              <option><%=rs.getString("userroles") %></option>
                              <option>User</option>
