		...
		<script>
		 function Log_out()
		 {
		     ...
		     if (hi== true){
		        ...
		        window.location.href = 'managealljobs.jsp';
		     }
		 }
		</script>
...
<%@include file = '/Views/nav/header.jsp' %>							
		...
		<div class="card">
            <div class="card-body">
              <h4 class="card-title">View all Jobs</h4>
              <div class="row">
                <div class="col-12">
                  ...
                  <form name="form1" id="form1" action="/ContitouchH/DelItem"  method="post">
                    ...
                    String username =  session.getAttribute("User").toString();	
              		System.out.println("Testing"+username);
						...
						String val = "TRUE";
						String query="select *  from jobs where del_indicator != '"+val+"' AND assignedto='"+username+"'    ";
