                  ...
                  <form name="form1" id="form1" action="/ContitouchH/UserAccountsActions"  method="post">
                    <table id="order-listing" class="table">
                      ...
                      <%Connection mysqlConn = null;
    					...
    					String username01 =  session.getAttribute("User").toString();	
                  		System.out.println("Testing"+username01);

						Statement stmt = null;
						stmt = mysqlConn.createStatement();
						ResultSet resultset =null;
						String val = "TRUE";
						String query="select *  from users where del_indicator != '"+val+"' AND email != '"+username01+"'   ";
