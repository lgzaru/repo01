<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    pageEncoding="ISO-8859-1"  import="controller.TestObject"  import= "java.util.ArrayList"
   ...
   <head>
       ...
       <%  TestObject obj = new TestObject();
		...
		Gson gSon = new Gson();
			 ...
			 String allusersjson = gSon.toJson(myusers);%>
       ...
       $(function() {
    	   ...
    	   'use strict';
    	   var data = {
    	     labels: <%out.print(allusersjson);%>,
    	     datasets: [{
    	       label: 'Number of Tasks',
    	       data: <%out.print(totals);%>,
    	       backgroundColor: [
    	         'rgba(255, 99, 132, 0.2)',
    	         'rgba(54, 162, 235, 0.2)',
    	         'rgba(255, 206, 86, 0.2)',
