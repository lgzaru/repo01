...
<title>Contitouch</title>
  ...
  <%@include file = 'viewproject-tasks.jsp' %>
		...
		<script>
		 function Log_out()
		 {
		     ...
		     if (hi== true){
		        ...
		        window.location.href = 'project-tasksv.jsp';
		     }
		 }
		</script>
...
<%@include file = '/Views/nav/navigation.jsp' %>
      ...
      <div class="main-panel">
		...
		<div class="card">
            <div class="card-body">
              <h4 class="card-title">Tasks Per Project</h4>
              <div class="row">
                <div class="col-12">
                      ...
                      <%Connection mysqlConn = null;
                        ...
                        <tr>
                            ...
                            <td>
                              ...
                              <button  class="btn btn-info" name="viewproject-tasks" id="viewproject-tasks">View Tasks</button>
