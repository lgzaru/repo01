...
<head>
  ...
  <%@include file = 'sessions.jsp' %>
		...
		<%  String datereceived = session.getAttribute("datereceived").toString();
		   String projectname = session.getAttribute("projectname").toString();
		    String summary = session.getAttribute("summary").toString();
		    String clientid = session.getAttribute("clientid").toString();
		     String filename = session.getAttribute("filename").toString();
		     //String fileurl = "file:///C:/fileuploads/projecttracker/null/"+filename; fileurl
 ...
 <div class="content-wrapper">
          ...
          <div class="col-12 grid-margin">
              <div class="card">
                  ...
                  <form class="form-sample" action="/ContitouchH/CreateProject" method="post">
                    <p class="text-danger">
                      ...
                      <p class="text-success">
                              <i class="mdi mdi-alert-octagon mr-2"  ></i><a href="<%out.print(fileurl); %>" ><%out.print(filename); %></a>
                              <br><br>
                            </p>
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input type="text" name="pname" id="pname" value="<%out.print(projectname); %>" class="form-control" />
                          </div>
                        </div>
                      </div>
                      <div class="col-md-6">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input name="requester" id="requester"  type="text" value="<%out.print(clientid); %>"  class="form-control" />
                          </div>
                        </div>
                      </div>
					...
					<div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input class="form-control" type="date" value="<%out.print(datereceived); %>" id="rrd" name="rrd">
                          </div>
                        </div>
                      </div>
               ...
               <option value="<%out.print(clientid); %>"><%out.print(clientid); %></option>
               <% while(resultset.next()){ %>
				   ...
				   System.out.println("error1"+e);
                       ...
                       <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <textarea name="comments" id="comments" type="text"  rows="8" class="form-control" /><% out.print(summary);%></textarea>
                          </div>
                        </div>
                      </div>
